...
graph = Graph()
graph.parse('ontology_metadata/dpv-owl.ttl', format='turtle')
DPV_GRAPH += graph
...
graph = Graph()
graph.parse('ontology_metadata/dpv-owl-gdpr.ttl', format='turtle')
DPV_GDPR_GRAPH += graph
...
# serialize
DPV_PD_GRAPH.parse('ontology_metadata/dpv-owl-pd.ttl', format='turtle')
...
DPV_LEGAL_GRAPH.parse('ontology_metadata/dpv-owl-legal.ttl', format='turtle')
...
graph = Graph()
graph.parse('ontology_metadata/dpv-owl-risk.ttl', format='turtle')
RISK_GRAPH += graph
...
# serialize
RIGHTS_EU_GRAPH.parse('ontology_metadata/dpv-owl-rights-eu.ttl', format='turtle')
