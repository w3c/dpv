...
IMPORT_RISK_PATH = '../dpv-skos/risk/risk.ttl'
IMPORT_RISK_MODULES_PATH = '../dpv-skos/risk/modules'
EXPORT_RISK_HTML_PATH = '../dpv-skos/risk'
...
EXPORT_RIGHTS_HTML_PATH = '../dpv-skos/rights'
...
for legalbasis in TEMPLATE_DATA['legal_basis_classes']:
    rights = []
    for right in legalbasis.dpvs_hasRight:
